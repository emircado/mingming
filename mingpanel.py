...
_switches = [
	...
	mingswitch(30, 'Eyes', BTN_2, ('Make singkit eyes', 'Widen eyes')),
	mingswitch(31, 'Meteor Garden', BTN_2, ('Watch Meteor Garden', 'Fangirl Meteor Garden')),
	mingswitch(32, 'Tour', BTN_2, ('Tour China', 'Tour Hong Kong')),
	mingswitch(33, 'World War', BTN_3, ('Start World War I', 'Start World War II', 'Start World War III')),
	mingswitch(34, 'Speak Chinese', BTN_2, ('Ni hao', 'Jia you')),
	mingswitch(35, 'Territory', BTN_2, ('Scratch on territory', 'Pee on territory')),
